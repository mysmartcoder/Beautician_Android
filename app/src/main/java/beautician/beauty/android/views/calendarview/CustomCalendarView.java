package beautician.beauty.android.views.calendarview;
...
import beautician.beauty.android.views.OnSwipeTouchListener;
...
//    private int currentMonthIndex = 0;
    ...
    public List<AppointmentDataParser> mListEvents = new ArrayList<AppointmentDataParser>();
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        calendarTitleTextColor = typedArray.getColor(R.styleable.CustomCalendarView_calendarTitleTextColor, getResources().getColor(R.color.myPrimaryColor));
        ...
        dayOfWeekTextColor = typedArray.getColor(R.styleable.CustomCalendarView_dayOfWeekTextColor, getResources().getColor(R.color.myPrimaryColor));
        dayOfMonthTextColor = typedArray.getColor(R.styleable.CustomCalendarView_dayOfMonthTextColor, getResources().getColor(R.color.myPrimaryColor));
        ...
        for (int i = 1; i < 43; i++) {
            ...
            if(dView!=null) {
                ...
                for (int k = 0; k < mListEvents.size(); k++) {
                    String start_time = mListEvents.get(k).getAppointment_starttime();
                    String c_date = getDateInFormateFromDate(dayView.getDate(), StaticData.DATE_FORMAT_1);
                    String a_date = getDateInFormate(start_time, StaticData.DATE_FORMAT_6, StaticData.DATE_FORMAT_1);
                    if(c_date.equalsIgnoreCase(a_date))
                    {
                        dView.setVisibility(View.VISIBLE);
                        if (mListEvents.get(k).getAppointment_status().equalsIgnoreCase(StaticData.APPOINTMENT_STATUS_CANCEL))
                            dView.setImageResource(R.drawable.circle_red);
                        else
                            dView.setImageResource(R.drawable.circle_golden);
                    }
                }

//                if (mListEvent.contains(getDateInFormateFromDate(dayView.getDate(), StaticData.DATE_FORMAT_1))) {
//                    dView.setVisibility(View.VISIBLE);
////                dayView.setCompoundDrawablesWithIntrinsicBounds(null,null,null,ContextCompat.getDrawable(mActivity,R.drawable.icon_add_beauty_service_down_arrow));
//                } else
//                    dView.setVisibility(View.INVISIBLE);
            }
    ...
    public void setAppointment(List<AppointmentDataParser> list)
    {
        mListEvents = list;
    }

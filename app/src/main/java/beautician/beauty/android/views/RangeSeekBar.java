...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.icon_radio_btn_selected);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(),
                                                                          R.drawable.icon_radio_btn_selected);
     ...
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xA4, 0x2E, 0xAD);
    /**
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        paint.setColor(ContextCompat.getColor(getContext(), R.color.myPrimaryColor));
        ...
        if (!selectedValuesAreDefault) {
            paint.setTextSize(mTextSize);
            paint.setColor(ContextCompat.getColor(getContext(), R.color.golden));

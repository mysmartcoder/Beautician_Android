...
public class TwitterHelper {
    ...
    private static final String TWITTER_KEY = "L9wu0PQDBDuFPOI3ipOurSzvA";
    private static final String TWITTER_SECRET = "eng7n6bYkXII9AN2O9uN4jXHsdYf2EdcpHBtbzraxoFxmJxBG1";
